...
const file_proto_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x13proto/v1/user.proto\x12\auser.v1\"\x1d\n" +
	...
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.v1.UserRequest\x1a\x15.user.v1.UserResponseB\x1bZ\x19grpc-api-versioning/pb/v1b\x06proto3"
...
var file_proto_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_proto_v1_user_proto_depIdxs = []int32{
	0, // 0: user.v1.UserService.GetUser:input_type -> user.v1.UserRequest
